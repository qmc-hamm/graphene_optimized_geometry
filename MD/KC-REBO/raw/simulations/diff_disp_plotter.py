...
filename3 = '../../../FitttedKC-REBO/raw/simulations/'+folder+"/"+"dump_initial.txt";   
filename4 = '../../../FitttedKC-REBO/raw/simulations/'+folder+"/"+"dump_final.txt";  
figname1 = folder+'/diff_in-plane_bottom.png'
figname2 = folder+'/diff_in-plane_top.png'
