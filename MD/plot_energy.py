...
def scatterplotter(fig, ax, x, y, z, title, vmin=-7.427, vmax=-7.412, ylabel=None, colorbar=True, strip_width=None):
...
def plot_energy_side_by_side(twist_angle, pot1, pot2, label1, label2, atom_type=1):
    ...
    scatterplotter(fig, ax1, d1.x, d1.y, d1.energy, label1, vmin=-7.427, vmax=-7.412, ylabel='$y$ (ang)', colorbar=False)
    scatterplotter(fig, ax2, d2.x, d2.y, d2.energy, label2, vmin=-7.427, vmax=-7.412, ylabel=None, colorbar=True)
    fig.tight_layout()
...
def plot_z_side_by_side(twist_angle, pot1, pot2, label1, label2, atom_type=1):
    ...
    d2 = get_data(twist_angle, pot2)
    fig, (ax1, ax2) = plt.subplots(nrows=1, ncols=2, sharey=True, figsize=(6, 5))
    scatterplotter(fig, ax1, d1.x, d1.y, d1.z, label1, vmin=2.9, vmax=3.1, ylabel='$y$ (ang)', colorbar=False)
    scatterplotter(fig, ax2, d2.x, d2.y, d2.z, label2, vmin=2.9, vmax=3.1, ylabel=None, colorbar=True)
    fig.tight_layout()
