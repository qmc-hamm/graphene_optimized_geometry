...
if __name__=="__main__":
    ...
    theta1 = [4.4, 3.89, 2.88, 2.0, 1.89, 1.79, 1.7, 1.61, 1.54, 1.47, 1.41, 1.35, 1.29, 1.25, 1.2, 1.16, 1.08, 1.05, 0.99, 0.93, 0.84]#Input: Twist angle (Float)
    for i in range(len(theta1)):
        theta = theta1[i]
        theta2 = str(theta1[i])
        st = theta2.split('.')
        thetaname = st[0]+'-'+st[1]
        method = "MD-REBO-KC-dftd3fitted" #Input: method (String)
        ID = str(uuid.uuid4()) 
        date = 'Oct 5, 2022' #Input:date (String)
